...
CDT0ASwitchBoxDll::CDT0ASwitchBoxDll()
{
	m_pSwitch = NULL;
}
...
BOOL CDT0ASwitchBoxDll::OpenDevice(stDevType stType, LPCTSTR pszDeviceAddr, unsigned long *Comhandle)
{
	long lPolType=stType.bType;
	DWORD dwErrorCode = SUCCESS;

	if (DT0ASwitchBox == lPolType) 
	{
		m_pSwitch = new CDT0ASwitchBox();	
	}
	else 
	{
		sprintf(m_strMsg,"Set DT0A Device Type Error");
		return FALSE;
	}
	...
	{
		sprintf(m_strMsg,"%s",m_pSwitch->GetMsgString());
		return FALSE;
	}
...
BOOL CDT0ASwitchBoxDll::SetHandle(stDevType stType, LPCTSTR pszDeviceAddr, unsigned long handle)
{
	long lPolType=stType.bType;
	DWORD dwErrorCode = SUCCESS;
...
BOOL  CDT0ASwitchBoxDll::CloseDevice()
{
	DWORD dwErrorCode = SUCCESS;
	if (m_pSwitch!=NULL)
	{
	...
	{
		sprintf(m_strMsg,"DT0A Device ptr is NULL error");
		return FALSE;
	}
...
char* CDT0ASwitchBoxDll::GetMsgString()
{
...
//Time:20170601
////////////////////////////////////////////////////////////
BOOL CDT0ASwitchBoxDll::GetPNInfo(char *pstrPN)
{
	DWORD dwErrorCode = SUCCESS;
	if (m_pSwitch!=NULL)
	{
		dwErrorCode =m_pSwitch->GetPNInfo(pstrPN);
		if(dwErrorCode !=SUCCESS)
		{
			sprintf(m_strMsg,"%s",m_pSwitch->GetMsgString());
			return FALSE;
...
//Time:20170601
////////////////////////////////////////////////////////////
BOOL CDT0ASwitchBoxDll::GetSNInfo(char*  pstrSN)
{
	DWORD dwErrorCode = SUCCESS;
	if (m_pSwitch!=NULL)
	{
		dwErrorCode =m_pSwitch->GetSNInfo(pstrSN);
		if(dwErrorCode !=SUCCESS)
		{
			sprintf(m_strMsg,"%s",m_pSwitch->GetMsgString());
			return FALSE;
...
//Time:20170601
////////////////////////////////////////////////////////////
BOOL CDT0ASwitchBoxDll::GetEquipmentInfo(char* pstrEquipment)
{
	DWORD dwErrorCode = SUCCESS;
	if (m_pSwitch!=NULL)
	{
		dwErrorCode =m_pSwitch->GetEquipmentInfo(pstrEquipment);
		if(dwErrorCode !=SUCCESS)
		{
			sprintf(m_strMsg,"%s",m_pSwitch->GetMsgString());
			return FALSE;
...
//Time:20170601
////////////////////////////////////////////////////////////
BOOL CDT0ASwitchBoxDll::GetHWInfo(char* pstrHWVersion)
{
	DWORD dwErrorCode = SUCCESS;
	if (m_pSwitch!=NULL)
	{
		dwErrorCode =m_pSwitch->GetHWInfo(pstrHWVersion);
		if(dwErrorCode !=SUCCESS)
		{
			sprintf(m_strMsg,"%s",m_pSwitch->GetMsgString());
			return FALSE;
...
//Time:20170601
////////////////////////////////////////////////////////////
BOOL CDT0ASwitchBoxDll::GetMFGDateInfo(CString& strMFGDate)
{
	BYTE sbBuffer[MAX_PATH];
	BYTE bValueTemp[32];
