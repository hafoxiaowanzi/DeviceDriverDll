...
DWORD COSA_AQ6317B::InitOSARepeatSweep(double dblStartWL, double dblStopWL, double dblRBW, DWORD dwSweepPoint)
{
	DWORD dwErrorCode = SUCCESS;
	CHAR szCmdString[TXLENS];
	ZeroMemory(szCmdString, TXLENS * sizeof(CHAR));
...
//Time：2018/03/13
/////////////////////////////////////////////////////////////////////////////
DWORD COSA_AQ6317B::InitWDMTest(double dblStartWL,double dblStopWL,double dblRBW)
{
	DWORD   dwErrorCode = SUCCESS;
...
DWORD COSA_AQ6317B::SetOSALock(int nTimeOut)
{
	DWORD  dwErrorCode = SUCCESS;
	CHAR szCmdString[TXLENS];
...
DWORD COSA_AQ6317B::SetOSAUnlock()
{
	DWORD  dwErrorCode = SUCCESS;
	CHAR szCmdString[TXLENS];
