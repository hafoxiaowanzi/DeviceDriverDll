...
EXTERN_C const IID IID_IIOSAInterface;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE InitOSARepeatSweep( 
            /* [in] */ LONG lChIndex,
            /* [in] */ DOUBLE dblStartWL,
            /* [in] */ DOUBLE dblStopWL,
            /* [in] */ DOUBLE dblRBW,
    ...
    typedef struct IIOSAInterfaceVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *InitOSARepeatSweep )( 
            IIOSAInterface * This,
            /* [in] */ LONG lChIndex,
            /* [in] */ DOUBLE dblStartWL,
            /* [in] */ DOUBLE dblStopWL,
...
#define IIOSAInterface_InitOSARepeatSweep(This,lChIndex,dblStartWL,dblStopWL,dblRBW,lSweepPointCount)	\
    ( (This)->lpVtbl -> InitOSARepeatSweep(This,lChIndex,dblStartWL,dblStopWL,dblRBW,lSweepPointCount) ) 
