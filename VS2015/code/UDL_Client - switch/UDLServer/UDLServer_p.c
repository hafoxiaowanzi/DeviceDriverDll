...
typedef struct _UDLServer_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } UDLServer_MIDL_TYPE_FORMAT_STRING;

typedef struct _UDLServer_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } UDLServer_MIDL_PROC_FORMAT_STRING;

typedef struct _UDLServer_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } UDLServer_MIDL_EXPR_FORMAT_STRING;
...
extern const UDLServer_MIDL_TYPE_FORMAT_STRING UDLServer__MIDL_TypeFormatString;
extern const UDLServer_MIDL_PROC_FORMAT_STRING UDLServer__MIDL_ProcFormatString;
extern const UDLServer_MIDL_EXPR_FORMAT_STRING UDLServer__MIDL_ExprFormatString;
...
extern const MIDL_STUBLESS_PROXY_INFO IEngineMgr_ProxyInfo;
...
static const UDLServer_MIDL_PROC_FORMAT_STRING UDLServer__MIDL_ProcFormatString =
    {
        0,
        {
...
static const UDLServer_MIDL_TYPE_FORMAT_STRING UDLServer__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_UDLServer_0000_0000, ver. 0.0,
...
static const MIDL_STUBLESS_PROXY_INFO IEngineMgr_ProxyInfo =
    {
    &Object_StubDesc,
    UDLServer__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(16) _IEngineMgrProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IEngineMgr::get_GetVersion */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::put_GetVersion */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::get_GetLastMessage */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::put_GetLastMessage */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::OpenEngine */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::LoadConfiguration */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::RegisterUDL */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::SetUDLNET */ ,
    (void *) (INT_PTR) -1 /* IEngineMgr::ConnectToServer */
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    UDLServer__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _UDLServer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IEngineMgrProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _UDLServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IEngineMgrStubVtbl,
    0
};
...
const IID *  const _UDLServer_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
