...
public:
	...
	virtual BOOL  OpenDevice(LPCTSTR pszDeviceAddr,unsigned long *ComHandle) = 0;
	virtual BOOL  CloseDevice() = 0;
	virtual BOOL  SetHandle(LPCTSTR pszDeviceAddr, unsigned long handle) = 0;
	virtual BOOL GetPNInfo(char *pstrPN)=0;
    virtual BOOL GetSNInfo(char *pstrSN)=0;
	virtual BOOL GetEquipmentInfo(char *pstrEquipment)=0;
	virtual BOOL GetHWInfo(char *pstrHWVersion)=0;
	virtual BOOL GetFWInfo(char *pstrFWVersion)=0;
	virtual BOOL GetOplinkFWInfo(char *pstrOplinkVersion)=0;
	virtual BOOL GetMFGDateInfo(char* strMFGDate) =0 ;
...
public:
	...
	virtual BOOL  OpenDevice(LPCTSTR pszDeviceAddr,unsigned long *ComHandle);
	virtual BOOL  CloseDevice();
	virtual BOOL  SetHandle(LPCTSTR pszDeviceAddr, unsigned long handle);
	...
	virtual BOOL GetMFGDateInfo(char* pstrMFGDate);
