...
#if !defined(AFX_DT0ASWITCH_H__88FC36E0_6C41_4A8B_BEC2_424F42DE9755__INCLUDED_)
#define AFX_DT0ASWITCH_H__88FC36E0_6C41_4A8B_BEC2_424F42DE9755__INCLUDED_
...
public:
	CDT0ASwitchBoxDll();
	~CDT0ASwitchBoxDll();
	 BOOL OpenDevice(stDevType stType, LPCTSTR pszDeviceAddr,unsigned long *ComHandle);;	
 	 BOOL CloseDevice();
	 BOOL SetHandle(stDevType stType, LPCTSTR pszDeviceAddr, unsigned long handle);
	 ...
	 BOOL GetMFGDateInfo(char* pstrMFGDate);
