...
#include "..\\include\\JsonMsgStruct.h"

typedef struct tagTLSShareInfo
{
	char szSrvIP[256];
	char szPort[256];
	char szSlot[256];
...
public:
	...
	virtual DWORD SetTLSLock(long lChIndex, int nTimeOut,double dbSetWL)=0;
	virtual DWORD SetTLSUnlock(long lChIndex)=0;
};
...
public:
	...
	virtual DWORD SetTLSLock(long lChIndex, int nTimeOut, double dbSetWL);
	virtual DWORD SetTLSUnlock(long lChIndex);
private:
...
class CTLSShare : public CTLSControl
{
public:
	CTLSShare();
	virtual ~CTLSShare();
